...
public class SingleDiceRenderer : DiceRenderer
{
    ...
    /// </sumary>
    public void Setup(PixelDesignAndColor variant, int widthHeight)
    {
        ...
        die = GameObject.Instantiate<DiceRendererDice>(GetDieRenderer(variant), Vector3.zero, Quaternion.identity, dieRoot.transform);
    }
    ...
    public void SetAnimation(EditAnimation animation) => die.SetAnimation(animation);
    public void SetAnimations(IEnumerable<EditAnimation> animations) => die.SetAnimations(animations);
