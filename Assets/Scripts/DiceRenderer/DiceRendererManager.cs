...
public class DiceRendererManager : SingletonMonoBehaviour<DiceRendererManager>
{
    ...
    public SingleDiceRenderer CreateDiceRenderer(PixelDesignAndColor variant, int widthHeight = 256)
    {
    ...
    public MultiDiceRenderer CreateMultiDiceRenderer(List<PixelDesignAndColor> variants, int widthHeight = 256)
    {
